...
ted_input_file="/Users/qinyulin/English/TedScript.txt"
ted_input_pointer=open(ted_input_file,'r+')
ted_info=ted_input_pointer.readline()
ted_info_list=ted_info.split(',')
url_tedscript=ted_info_list[0]
ted_title=ted_info_list[1]
ted_author=ted_info_list[2]
file_output=ted_info_list[3]
